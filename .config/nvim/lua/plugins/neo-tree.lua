  ...
  opts = {
    ...
    filesystem = {
      ...
      filtered_items = {
        ...
        hide_dotfiles = false, -- ← НЕ скрывать dotfiles (файлы, начинающиеся с точки)
        hide_gitignored = false, -- ← ПОКАЗЫВАТЬ даже .gitignored файлы (по желанию)
      },
    },
    window = {
      ...
      popup = {
        size = {
          height = "50%", -- или фиксированное значение: например 40
          width = "40%",
        },
